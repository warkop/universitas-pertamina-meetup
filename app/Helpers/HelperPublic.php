...
class HelperPublic
{
    ...
    */
    ...
    public static function generateAccessToken($group = 'dB528-')
    {
    ...
    public static function modelOptions($default, $options = [])
    {
        if (is_array($default)) {
    ...
    public static function customDecode($value, $find = ["{", "}"], $explodeWith = ","){
